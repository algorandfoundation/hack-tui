...
// AccountSelected waits for and retrieves a new set of table rows from a given channel.
func AccountSelected(account internal.Account) tea.Cmd {
	return func() tea.Msg {
		return account
	}
}
...
func (m ViewModel) HandleMessage(msg tea.Msg) (ViewModel, tea.Cmd) {
	...
	case internal.StateModel:
		m.Data = internal.AccountsFromParticipationKeys(msg.ParticipationKeys)
		m.table.SetRows(*m.makeRows())
	case tea.KeyMsg:
		switch msg.String() {
		case "enter":
			return m, AccountSelected(m.SelectedAccount())
		case "ctrl+c":
			return m, tea.Quit
		}
